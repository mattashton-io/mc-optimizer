...
```bash
python3 tco_report_generator.py assessment --cores 16 --ram 32 --disk 20 --passmark 750 --cpu-util 0.5 --disk-util 0.4 --target-series c4d
```
...
```bash
python3 tco_report_generator.py airlift --total-vcpus 1000 --total-ram 4000 --total-disk 10000
```
...
```bash
python3 tco_report_generator.py mc-report
```
