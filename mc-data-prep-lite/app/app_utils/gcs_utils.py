...
def get_bucket_name():
    ...
    try:
        ...
        print(
            f"Bucket {bucket_name} exists but is not readable (403 Forbidden). Proceeding..."
        )
    except Exception:
        print(
            f"Bucket {bucket_name} not found or inaccessible. Attempting to create..."
        )
        try:
            ...
            print(
                f"Warning: Failed to create bucket {bucket_name} (might already exist): {e}"
            )
